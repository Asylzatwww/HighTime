...
public class Test5Activity extends Test1Activity {
        ...
        if (getIntent().hasExtra("EXTRA_TEST_FROM_SERVER")) {
            ...
            buttonPrevious.setOnClickListener(new View.OnClickListener() {
                public void onClick(View arg0) {
                    Intent myIntent = new Intent(Test5Activity.this, Test4Activity.class);
            ...
            if (nextBtnShow)
                buttonNext.setOnClickListener( new View.OnClickListener(){
                    public void onClick(View arg0){
                        Intent myIntent=new Intent(Test5Activity.this,Test6Activity.class);
                        myIntent.putExtra("EXTRA_TEST_FROM_SERVER", "true"  );
                        startActivity(myIntent);
                    }
                } );
                ...
                buttonNext.setOnClickListener( new View.OnClickListener(){
                    public void onClick(View arg0){
                        Intent myIntent=new Intent(Test5Activity.this, InstructionActivity.class);
                        myIntent.putExtra("EXTRA_TEST_FROM_SERVER", "true"  );
                        startActivity(myIntent);
                    }
                } );
